...
#Preview {
  EndingCandEShapeGroup(width: 23, height: 96, radius: 2.5, widthMultiplier: 1, offset: 0, keyShape: EndingCandEShape(width: 23, height: 96, radius: 2.5, widthMultiplier: 1), fill: .white, stroke: .black, lineWidth: 1, z_Index: 0)
}
